...
@section('content')
            ...
            <div class="banner position-relative">
                ...
                <div class="box-header container-fluid">
                    ...
                    <div class="col-lg-12 text-center hidden-sm">
                        ...
                        <h1 class="color-white text-50 color-title-packages">{{str_replace('-', ' ', strtoupper($type))}} ({{$duration}} days)</h1>
    ...
    <div class="container-category hidden-sm">
    ...
    <div class="container">
        <div class="row margin-top-20">
            <div class="col-lg-12 text-center font-montserrat">
                <h2 class="text-30 color-goto-orange"><b>PERU TRAVEL PACKAGES: {{str_replace('-', ' ', strtoupper($type))}} ({{$duration}} days)</b></h2>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="box-duration">
                            @foreach($paquete_d->unique('duracion')->sortBy('duracion') as $duracion)
