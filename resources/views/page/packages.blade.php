                ...
                <div class="box-header container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            ...
                            <h1 class="color-white text-50 color-title-packages">PERU TRAVEL FEATURED PACKAGES</h1>
    ...
    <div class="container">
        <div class="row margin-top-20">
            <div class="col-lg-12 text-center font-montserrat">
                <h2 class="text-30 color-goto-orange"><b>PERU TRAVEL FEATURED PACKAGES</b></h2>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box-duration">
                            @foreach($paquete->unique('duracion')->sortBy('duracion') as $duracion)
                                <p class="no-margin"><a href=""><i class="fa fa-check" aria-hidden="true"></i> {{$duracion->duracion}} days</a></p>
                            @endforeach
