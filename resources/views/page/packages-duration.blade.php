        ...
        <div class="banner position-relative">
            ...
            <div class="box-header container-fluid">
                ...
                <div class="col-lg-12 text-center hidden-sm">
                    ...
                    <h1 class="color-white text-50 color-title-packages">Travels Packages: {{$duration}} days</h1>
...
<div class="container">
    <div class="row margin-top-20">
        <div class="col-lg-12 text-center font-montserrat">
            <h2 class="text-30 color-goto-orange"><b>PERU TRAVEL PACKAGES: {{$duration}} days</b></h2>
