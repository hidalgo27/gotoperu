                                        ...
                                        <div class="col-lg-10 no-padding">
                                            <div class="row">
                                                <div class="col-lg-12 no-padding">
                                                    <div class="padding-5">
                                                        <div class="design-content">
                                                            <textarea name="" id="f_description" rows="4" placeholder="What can we do for you? We have it all. Just ask!"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-lg-10 no-padding">
                                            <div class="row">
                                                <div class="col-lg-12 no-padding">
                                                    <div class="padding-5">
                                                        <div class="design-content">
                                                            <input type="text" name="f_email" id="f_email" placeholder=" Email (Required)" size="45">
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-lg-10 no-padding">
                                            <div class="row">
                                                <div class="col-lg-12 no-padding">
                                                    <div class="padding-5">
                                                        <div class="design-content">
                                                            <input type="text" name="f_phone" id="f_phone" value="" placeholder=" Phone" size="45">
                                                        </div>
                                                    </div>
                                                </div>
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <div class="row">
                    <div class="col-md-12">
                        <div class="padding-5">
                            <a href="#" id="step1-link" class="btn btn-lg btn-default hide">Skip <span style="display: none;">Previous</span></a>
                            ...
                            <button class="btn btn-lg btn-info pull-right hide" id="f_send" type="button" onclick="sendDesign()">Submit
                                <i class="fa fa-paper-plane" aria-hidden="true"></i>
                            </button>
                            <div class="loader pull-right margin-top-20 hide" id="loader">Loading...</div>
